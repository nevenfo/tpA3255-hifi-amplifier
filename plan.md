...
- [ ] E1.9 Poser une règle DRC pour l'isolation pastille-à-pastille interne aux boîtiers à pas fin. **Ajouté en cours de Phase E**, révélé par le DRC d'après placement.
  ...
  - **Piège identifié avant écriture** : `min_clearance` vaut `0.2` dans le `.kicad_pro` et agit comme **plancher absolu** — l'isolation résolue est le maximum de la règle et de ce plancher. Une règle à 0,15 mm resterait donc sans effet sur les 8 cas à 0,150 mm tant que le plancher n'est pas abaissé d'autant. L'abaisser à 0,15 ne relâche rien ailleurs : toutes les classes de nets sont à 0,25 mm ou plus, et 0,15 mm reste très au-dessus des capacités courantes d'un fabricant.
