...
- [ ] E1.5 Revoir symétrie, retour des courants, masses, clearances et manufacturabilité. *(EN COURS — tranche « symétrie mesurée » = PASS, en lecture seule.)*
  ...
  - **Question laissée ouverte, à trancher dans une tranche dédiée** : faut-il replacer les quatre selfs **en miroir autour de `y` = 175**, à l'image du brochage, plutôt qu'en deux rangées translatées ? Le miroir apparierait A↔D et B↔C par construction, mais déplace les borniers hors symétrie et se heurte à la zone interdite de la barre de liaison. C'est le seul des trois écarts dont la correction n'est pas gratuite. Chiffrage définitif sur le routage réel, en F1.
